              ...
              <Card.Body>
                ...
                >
                  ...
                  <svg viewBox="0 0 128 128">
                    ...
                    <path
                      fill="url(#b)"
                      d="M91.682 28.38v10.966c0 8.5-7.208 15.655-15.426 15.655h-24.665c-6.756 0-12.346 5.783-12.346 12.549v23.515c0 6.691 5.818 10.628 12.346 12.547 7.816 2.297 15.312 2.713 24.665 0 6.216-1.801 12.346-5.423 12.346-12.547v-9.412h-24.664v-3.138h57.012c7.176 0 9.852-5.005 12.348-12.519 2.578-7.735 2.467-15.174 0-25.096-1.774-7.145-5.161-12.521-12.348-12.521h-9.268zm-13.873 59.547c2.561 0 4.634 2.097 4.634 4.692 0 2.602-2.074 4.719-4.634 4.719-2.55 0-4.633-2.117-4.633-4.719 0-2.595 2.083-4.692 4.633-4.692z"
                    ></path>
                    <radialGradient
                      id="c"
                      cx="1825.678"
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">HTML 5</h5>
                  <svg viewBox="0 0 128 128">
                    <path
                      fill="#E44D26"
                    ...
                    <path
                      fill="#EBEBEB"
                      d="M64 52.455h-18.212l-1.258-14.094h19.47v-13.762h-34.511l.33 3.692 3.382 37.927h50.799zM64 88.198l-.061.017-15.327-4.14-.979-10.975h-13.817l1.928 21.609 28.193 7.826.063-.017z"
                    ></path>
                    <path
                      fill="#fff"
                      d="M63.952 52.455v13.763h16.947l-1.597 17.849-15.35 4.143v14.319l28.215-7.82.207-2.325 3.234-36.233.335-3.696h-3.708zM63.952 24.599v13.762h53.244l.276-3.092.628-6.978.329-3.692z"
                    ></path>
                  </svg>
                </a>
              </Card.Body>
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">CSS 3</h5>
                  <svg viewBox="0 0 128 128">
                    <path
                      fill="#1572B6"
                    ...
                    <path
                      fill="#fff"
                      d="M64.001 51.429h18.302l1.264-14.163h-19.566v-13.831h54.681999999999995l-.332 3.711-3.4 38.114h-30.95v-13.831z"
                    ></path>
                    <path
                      fill="#EBEBEB"
                    ...
                    <path
                      fill="#EBEBEB"
                      d="M64.048 23.435v13.831000000000001h-33.407999999999994l-.277-3.108-.63-7.012-.331-3.711h54.646zM64.001 51.431v13.831000000000001h-15.209l-.277-3.108-.631-7.012-.33-3.711h16.447z"
                    ></path>
                  </svg>
                </a>
              </Card.Body>
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">Visual Studio</h5>
                  <svg viewBox="0 0 128 128">
                    <path
                      fill="#68217a"
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">Go</h5>
                  <svg viewBox="0 0 128 128">
                    <defs>
                      <path
                        id="go-original-a"
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">Tensorflow</h5>
                  <svg viewBox="0 0 128 128">
                    <defs>
                      <path
            ...
            <Card className="card shadow-lg p-3 mb-5 bg-white rounded">
              <Card.Body>
                <a
                  ...
                  rel="noreferrer noopener"
                >
                  <h5 className="text-center">Pandas</h5>
                  <svg viewBox="0 0 128 128">
                    <path
